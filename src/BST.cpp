...
void BinarySearchTree::searchTreeInsert(const TreeItemType& newItem) throw(TreeException) {
...
void BinarySearchTree::deleteItem(TreeNode *& treePtr, KeyType searchKey) throw(TreeException) {// Calls: deleteNodeItem.
   if (treePtr == NULL)
